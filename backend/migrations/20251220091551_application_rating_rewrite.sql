...
CREATE INDEX IDX_campaign_rating_categories_campaign
    ON campaign_rating_categories(campaign_id);
...
CREATE INDEX IDX_application_rating_category_rating_application_rating ON application_rating_category_ratings(application_rating_id);
CREATE INDEX IDX_application_rating_category_rating_campaign_rating_category ON application_rating_category_ratings(campaign_rating_category_id);
