...
impl User {
    ...
    pub async fn update_name(id: i64, name: String, pool: &Pool<Postgres>) -> Result<(), ChaosError> {
        let _ = sqlx::query!(
        "
    ...
    pub async fn update_pronouns(id: i64, pronouns: String, pool: &Pool<Postgres>) -> Result<(), ChaosError> {
        let _ = sqlx::query!(
        "
    ...
    pub async fn update_gender(id: i64, gender: String, pool: &Pool<Postgres>) -> Result<(), ChaosError> {
        let _ = sqlx::query!(
        "
