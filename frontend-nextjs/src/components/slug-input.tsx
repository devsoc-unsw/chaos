...
export default function SlugInput({ orgId, name, value, currentSlug, onChange, dict }: { orgId: string, name: string, value: string, currentSlug?: string, onChange: (value: string) => void, dict: any }) {
    ...
    return (
        <>
            ...
            <Input className="max-w-[300px]" type="text" value={value} onChange={(e) => onChange(e.target.value)} onBlur={() => checkSlugAvailability()} />
