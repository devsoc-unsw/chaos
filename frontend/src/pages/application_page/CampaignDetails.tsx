...
const CampaignDetails = ({
  ...
  <Card as="header" tw="items-center gap-6 md:(flex-row items-start)">
    ...
    <aside tw="m-auto w-full flex max-w-lg flex-shrink-0 items-center justify-center overflow-hidden rounded shadow-md bg-[#edeeef] aspect-ratio[16/9] md:(w-1/2 mr-0)">
      <img
