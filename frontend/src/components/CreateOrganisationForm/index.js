...
import { FormContainer, ImageUploadWrapper, TextInput, UploadButton } from './createOrganisationForm.styled';
  ...
  return (
    <FormContainer>
      <ImageUploadWrapper htmlFor='imgInput'>
          <OrgIconImage src={uploadedImage.image ? uploadedImage.url : newImageIcon} />
